			...
			$.fn.extend({
				...
				updateDepthClass : function(current, prev) {
					return this.each(function(){
						...
						$(".menu-item-depth", this).val(current);
					});
				},
				shiftDepthClass : function(change) {
					return this.each(function(){
						...
						$(".menu-item-depth", this).val(depth + change);
					});
				},
		...
		initSortables : function() {
			...
			api.menuList.sortable({
				...
				start: function(e, ui) {
					...
					width = ui.helper.find('.item-view').outerWidth(); // Get original width
