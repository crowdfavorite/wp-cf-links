...
<ul class="subsubsub">
	<li>
		<a href="<?php echo admin_url('options-general.php?page=cf-links&cflk_page=main'); ?>" <?php echo $main_text; ?>><?php _e('Links Lists', 'cf-links'); ?></a> | 
	</li>
	<li>
		<a href="<?php echo admin_url('options-general.php?page=cf-links&cflk_page=create'); ?>" <?php echo $add_text; ?>><?php _e('New Links List', 'cf-links'); ?></a> | 
	</li>
	<li>
		<a href="<?php echo admin_url('options-general.php?page=cf-links&cflk_page=import'); ?>" <?php echo $import_text; ?>><?php _e('Import/Export Links List', 'cf-links'); ?></a> | 
	</li>
	<li>
